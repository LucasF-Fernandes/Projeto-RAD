...
def dados_clientes(): #função para pegar os dados do cliente
    cpf = cpf_entry.get()
    nome = nome_cliente_agenda_entry.get()
...
def dados_barbeiros(): #função para pegar os dados do barbeiros
    id = id_barbeiro_agenda_entry.get()
...
nome_cliente_agenda_entry = tk.Entry(root)
nome_cliente_agenda_entry.grid(row=1, column=1)
...
id_barbeiro_agenda_entry = tk.Entry(root)
id_barbeiro_agenda_entry.grid(row=5, column=1)
